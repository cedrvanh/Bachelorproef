...
@section("form-fields")
    <div class="form-row">
        <div class="form-group col-md-12">
            ...
            <input type="text" class="form-control" id="inputName" placeholder="Enter task name" name="name" value="{{ old('name') }}">
        </div>
    </div>
    <div class="form-row">
        <div class="form-group col-md-12">
            <label for="inputDescription">Description</label>
            <textarea class="form-control" id="inputDescription" placeholder="Enter a short task description" name="description" rows="3">{{ old('description') }}</textarea>
        </div>
    </div>
    <div class="form-row">
        <div class="form-group col-md-12">
    ...
    <div class="form-row">
        <div class="form-group col-md-12">
            ...
            <input type="number" class="form-control" id="inputReward" placeholder="Enter the reward" name="reward" value="{{ old('reward') }}">
        </div>
    </div>
    <div class="form-row">
        <div class="form-group col-md-12">
